...
public class AssociatioAudioVideo {
	...
	static public void videoToArray(ClusterSet clusterSet) throws DiarizationException {
		...
		logger.finest("----- 1 -------");
		TreeMap<Integer, fr.lium.experimental.spkDiarization.libNamedSpeaker.AudioInfo> info = new TreeMap<Integer, fr.lium.experimental.spkDiarization.libNamedSpeaker.AudioInfo>();
