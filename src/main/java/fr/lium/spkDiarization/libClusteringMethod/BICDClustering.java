...
public class BICDClustering extends BICHClustering {
	...
	/*
	 * (non-Javadoc)
	 * @see fr.fr.lium.spkDiarization.libClusteringMethod.BICHClustering#initialize(int, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see fr.fr.lium.spkDiarization.libClusteringMethod.HClustering#getScoreOfCandidatesForMerging()
	 */
	@Override
