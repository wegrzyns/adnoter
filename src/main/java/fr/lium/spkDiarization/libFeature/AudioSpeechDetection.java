...
public class AudioSpeechDetection {
	 ...
	 */
	protected static ClusterSet BiGaussienThresholdedMethod(fr.lium.spkDiarization.libFeature.AudioFeatureSet featureSet) {
		/*
	 ...
	 */
	protected static void EnergyThresholdMethod(fr.lium.spkDiarization.libFeature.AudioFeatureSet featureSet) throws DiarizationException, IOException {
		// clusters result
	 ...
	 * @throws IOException Signals that an I/O exception has occurred.
	 */
	public static void speechDetection(fr.lium.spkDiarization.libFeature.AudioFeatureSet featureSet) throws DiarizationException, IOException {
