...
public class DiarizationResultList {
	...
	/** The list. */
	private ArrayList<fr.lium.spkDiarization.lib.libDiarizationError.DiarizationResult> list;
	 ...
	 * @throws DiarizationException the diarization exception
	 */
	public void setResult(double previousScore, double score, fr.lium.spkDiarization.lib.libDiarizationError.DiarizationResult diarizationResult) throws DiarizationException {
	...
	protected void initialize() {
		list = new ArrayList<fr.lium.spkDiarization.lib.libDiarizationError.DiarizationResult>();
		list.ensureCapacity((max - min) + 1);
		for (int i = min; i <= max; i++) {
			list.add(i - min, new fr.lium.spkDiarization.lib.libDiarizationError.DiarizationResult(getThershold(i - min), 0, 0, 0, 0, 0));
		}
	}
	 ...
	 */
	protected fr.lium.spkDiarization.lib.libDiarizationError.DiarizationResult findMinimumError() {
		int index = -1;
	...
	public void log(String key) {
		fr.lium.spkDiarization.lib.libDiarizationError.DiarizationResult minimumError = findMinimumError();
