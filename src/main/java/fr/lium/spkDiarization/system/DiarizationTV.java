...
public class DiarizationTV {
	...
	/** The Constant logger. */
	private final static Logger logger = Logger.getLogger(fr.lium.spkDiarization.system.Diarization.class.getName());
	...
	static ArrayList<fr.lium.spkDiarization.system.Diarization> diarizationList;
...
//		for (fr.lium.spkDiarization.system.Diarization diarization : diarizationList) {
//			if (diarization.isThreadAlive()) {
//				return true;
//			}
//		}
//		return false;
//	}
	...
	public void tunEster2Corpus(Parameter parameter) throws DiarizationException, Exception {
		...
		diarizationList = new ArrayList<fr.lium.spkDiarization.system.Diarization>(nbThread);
