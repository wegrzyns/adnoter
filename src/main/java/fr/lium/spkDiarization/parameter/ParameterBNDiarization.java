...
public class ParameterBNDiarization extends ParameterBase implements Cloneable {
	 ...
	 */
	private class ActionCEClustering extends fr.lium.spkDiarization.parameter.LongOptAction {
	 ...
	 */
	private class ActionThread extends fr.lium.spkDiarization.parameter.LongOptAction {
	 ...
	 */
	private class ActionSaveAllStep extends fr.lium.spkDiarization.parameter.LongOptAction {
	 ...
	 */
	private class ActionLastStepOnly extends fr.lium.spkDiarization.parameter.LongOptAction {
	 ...
	 */
	private class ActionLoadInputSegmentation extends fr.lium.spkDiarization.parameter.LongOptAction {
	 ...
	 */
	private class ActionSystem extends fr.lium.spkDiarization.parameter.LongOptAction {
	...
	private class ActionThresholdsString extends LongOptAction {
		...
		/*
		 * (non-Javadoc)
		 * @see fr.fr.lium.spkDiarization.parameter.LongOptAction#log(java.util.logging.Logger, fr.fr.lium.spkDiarization.parameter.LongOptWithAction)
		 */
		@Override
		public void log(Logger logger, fr.lium.spkDiarization.parameter.LongOptWithAction longOpt) {
	...
	public ParameterBNDiarization(Parameter parameter) {
		...
		addOption(new fr.lium.spkDiarization.parameter.LongOptWithAction("system", new ActionSystem(), "selection the diarization module"));
		addOption(new fr.lium.spkDiarization.parameter.LongOptWithAction("thresholds", new ActionThresholdsString(), "thresholds of all step"));
		addOption(new fr.lium.spkDiarization.parameter.LongOptWithAction("doCEClustering", 0, new ActionCEClustering(), "make the CLR/NCLR clustering"));
		addOption(new fr.lium.spkDiarization.parameter.LongOptWithAction("nbThread", new ActionThread(), "number of shows process in parallele"));
		addOption(new fr.lium.spkDiarization.parameter.LongOptWithAction("saveAllStep", 0, new ActionSaveAllStep(), "save all intermediate diarization"));
		addOption(new fr.lium.spkDiarization.parameter.LongOptWithAction("lastStepOnly", 0, new ActionLastStepOnly(), "need an input diarization"));
