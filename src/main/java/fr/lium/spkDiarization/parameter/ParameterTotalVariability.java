...
public class ParameterTotalVariability extends ParameterBase implements Cloneable {
	 ...
	 */
	private class ActionTrainTotalVariabilityMatrix extends fr.lium.spkDiarization.parameter.LongOptAction {
	 ...
	 */
	private class ActionTotalVariabilityMatrixSize extends fr.lium.spkDiarization.parameter.LongOptAction {
	 ...
	 */
	protected class ActionTotalVariabilityMatrixMask extends fr.lium.spkDiarization.parameter.LongOptAction {
	 ...
	 */
	protected class ActionPartialTotalVariabilityMatrixMask extends fr.lium.spkDiarization.parameter.LongOptAction {
	 ...
	 */
	protected class ActionIntialTotalVariabilityMatrixMask extends fr.lium.spkDiarization.parameter.LongOptAction {
	 ...
	 */
	protected class ActionZeroOrderStatisticMask extends fr.lium.spkDiarization.parameter.LongOptAction {
	 ...
	 */
	protected class ActionFirstOrderStatisticMask extends fr.lium.spkDiarization.parameter.LongOptAction {
	...
	public ParameterTotalVariability(Parameter parameter) {
		...
		addOption(new fr.lium.spkDiarization.parameter.LongOptWithAction("tvNbIt", new ActionNumberOfInteration(), "number of iteration during the training"));
		addOption(new fr.lium.spkDiarization.parameter.LongOptWithAction("tvTrainTotalVariabilityMatrix", new ActionTrainTotalVariabilityMatrix(), "train total variability matrix before i-vector training"));
		addOption(new fr.lium.spkDiarization.parameter.LongOptWithAction("tvSize", new ActionTotalVariabilityMatrixSize(), "the size of an i-vector"));
		addOption(new fr.lium.spkDiarization.parameter.LongOptWithAction("tvPartialTotalVariabilityMatrixMask", new ActionPartialTotalVariabilityMatrixMask(), "the mask of partial Total Variability Matrix (inital, + one per iteration)"));
		addOption(new fr.lium.spkDiarization.parameter.LongOptWithAction("tvTotalVariabilityMatrixMask", new ActionTotalVariabilityMatrixMask(), "the mask of partial Total Variability Matrix"));
		addOption(new fr.lium.spkDiarization.parameter.LongOptWithAction("tvIntialTotalVariabilityMatrixMask", new ActionIntialTotalVariabilityMatrixMask(), ""));
		addOption(new fr.lium.spkDiarization.parameter.LongOptWithAction("tvZeroOrderStatisticMask", new ActionZeroOrderStatisticMask(), ""));
