...
public class ParameterIVectorNormalization extends ParameterBase implements Cloneable {
	 ...
	 */
	private class ActionNumberOfInteration extends fr.lium.spkDiarization.parameter.LongOptAction {
	 ...
	 */
	protected class ActionMaskInterSessionCompensation extends fr.lium.spkDiarization.parameter.LongOptAction {
	 ...
	 */
	protected class ActionWCCN extends fr.lium.spkDiarization.parameter.LongOptAction {
	...
	public ParameterIVectorNormalization(Parameter parameter) {
		...
		addOption(new fr.lium.spkDiarization.parameter.LongOptWithAction("nEFRNbIt", new ActionNumberOfInteration(), "number of iteration in Eigen Factor Radial normalization"));
		addOption(new fr.lium.spkDiarization.parameter.LongOptWithAction("nEFRMask", new ActionMaskInterSessionCompensation(), "mask for Eigen Factor Radial normalizations xml file name"));
		addOption(new fr.lium.spkDiarization.parameter.LongOptWithAction("nWCCNMask", new ActionWCCN(), "mask for WCCN matrix xml file name"));
