...
public class ParameterVideoInputFeature extends ParameterBase implements Cloneable {
	 ...
	 */
	private class ActionVideoFeatureFormat extends fr.lium.spkDiarization.parameter.LongOptAction {
	...
	public ParameterVideoInputFeature(Parameter parameter) {
		super(parameter);
		setVideoMask("%s.avi");
		addOption(new fr.lium.spkDiarization.parameter.LongOptWithAction("videoMask", new ActionVideoMask(), "video mask"));
