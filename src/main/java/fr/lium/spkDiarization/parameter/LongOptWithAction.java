...
public class LongOptWithAction extends LongOpt {
	...
	/** The action. */
	private fr.lium.spkDiarization.parameter.LongOptAction action;
	 ...
	 */
	public LongOptWithAction(String name, int has_arg, fr.lium.spkDiarization.parameter.LongOptAction action, String comment) throws IllegalArgumentException {
		super(name, has_arg, null, fr.lium.spkDiarization.parameter.Parameter.getNextOptionIndex());
		this.action = action;
