...
public class ParameterNamedSpeaker extends ParameterBase implements Cloneable {
	 ...
	 */
	private class ActionThresholdDecision extends fr.lium.spkDiarization.parameter.LongOptAction {

		/*
		 * (non-Javadoc)
		 * @see fr.fr.lium.spkDiarization.parameter.LongOptAction#execute(java.lang.String)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see fr.fr.lium.spkDiarization.parameter.LongOptAction#getValue()
		 */
		@Override
	 ...
	 */
	private class ActionThresholdTranscription extends fr.lium.spkDiarization.parameter.LongOptAction {
	 ...
	 */
	private class ActionThresholdAudio extends fr.lium.spkDiarization.parameter.LongOptAction {
	 ...
	 */
	private class ActionThresholdVideo extends fr.lium.spkDiarization.parameter.LongOptAction {
	 ...
	 */
	private class ActionThresholdWriting extends fr.lium.spkDiarization.parameter.LongOptAction {
	 ...
	 */
	private class ActionNameAndGenderList extends fr.lium.spkDiarization.parameter.LongOptAction {
	 ...
	 */
	private class ActionDontCheckGender extends fr.lium.spkDiarization.parameter.LongOptAction {
	 ...
	 */
	private class ActionCloseListCheck extends fr.lium.spkDiarization.parameter.LongOptAction {
	 ...
	 */
	private class ActionBeliefFunctions extends fr.lium.spkDiarization.parameter.LongOptAction {
	 ...
	 */
	private class ActionMaximum extends fr.lium.spkDiarization.parameter.LongOptAction {
	 ...
	 */
	private class ActionHungarian extends fr.lium.spkDiarization.parameter.LongOptAction {
	 ...
	 */
	private class ActionFirstNameCheck extends fr.lium.spkDiarization.parameter.LongOptAction {
	 ...
	 */
	private class ActionFirstNameList extends fr.lium.spkDiarization.parameter.LongOptAction {
	 ...
	 */
	private class ActionUseAudio extends fr.lium.spkDiarization.parameter.LongOptAction {
	 ...
	 */
	private class ActionUseVideo extends fr.lium.spkDiarization.parameter.LongOptAction {
	 ...
	 */
	private class ActionUseTranscription extends fr.lium.spkDiarization.parameter.LongOptAction {
	 ...
	 */
	private class ActionUseWritting extends fr.lium.spkDiarization.parameter.LongOptAction {
	 ...
	 */
	private class ActionUseSCTMask extends fr.lium.spkDiarization.parameter.LongOptAction {
	...
	public ParameterNamedSpeaker(Parameter parameter) {
		...
		addOption(new fr.lium.spkDiarization.parameter.LongOptWithAction("nThresholdDecision", new ActionThresholdDecision(), "decision score threshold"));
		addOption(new fr.lium.spkDiarization.parameter.LongOptWithAction("nThresholdTranscription", new ActionThresholdTranscription(), "transcription score threshold"));
		addOption(new fr.lium.spkDiarization.parameter.LongOptWithAction("nThresholdAudio", new ActionThresholdAudio(), "audio score threshold"));
		addOption(new fr.lium.spkDiarization.parameter.LongOptWithAction("nThresholdVideo", new ActionThresholdVideo(), "video score threshold"));
		addOption(new fr.lium.spkDiarization.parameter.LongOptWithAction("nThresholdWriting", new ActionThresholdWriting(), "writing score threshold"));

		addOption(new fr.lium.spkDiarization.parameter.LongOptWithAction("nUseTranscription", 0, new ActionUseTranscription(), "use speaker identification base on audio transcription"));
		addOption(new fr.lium.spkDiarization.parameter.LongOptWithAction("nUseAudio", 0, new ActionUseAudio(), "use speaker identification base on audio model"));
		addOption(new fr.lium.spkDiarization.parameter.LongOptWithAction("nUseVideo", 0, new ActionUseVideo(), "use speaker identification base on video model"));
		addOption(new fr.lium.spkDiarization.parameter.LongOptWithAction("nUseWriting", 0, new ActionUseWritting(), "use speaker identification base on writing"));

		addOption(new fr.lium.spkDiarization.parameter.LongOptWithAction("nNameAndGenderList", new ActionNameAndGenderList(), "list of name (full name or firstname) with gender information"));
		addOption(new fr.lium.spkDiarization.parameter.LongOptWithAction("nDontCheckGender", 0, new ActionDontCheckGender(), "remove the gender check"));
		addOption(new fr.lium.spkDiarization.parameter.LongOptWithAction("nCloseListCheck", 0, new ActionCloseListCheck(), "check the present of the speaker in --nNameAndGenderList list"));

		addOption(new fr.lium.spkDiarization.parameter.LongOptWithAction("nBeliefFunctions", 0, new ActionBeliefFunctions(), ""));
		addOption(new fr.lium.spkDiarization.parameter.LongOptWithAction("nMaximum", 0, new ActionMaximum(), ""));
		addOption(new fr.lium.spkDiarization.parameter.LongOptWithAction("nHungarian", 0, new ActionHungarian(), ""));

		addOption(new fr.lium.spkDiarization.parameter.LongOptWithAction("nFirstNameCheck", 0, new ActionFirstNameCheck(), "check the gender with a first name list"));
		addOption(new fr.lium.spkDiarization.parameter.LongOptWithAction("nFirstNameList", new ActionFirstNameList(), "list of first name with gender information"));

		addOption(new fr.lium.spkDiarization.parameter.LongOptWithAction("nIsTraining", 0, new ActionTraining(), "this a training corpus"));
