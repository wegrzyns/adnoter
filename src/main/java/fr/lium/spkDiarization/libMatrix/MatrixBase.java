...
public abstract class MatrixBase<T extends MatrixBase> implements Serializable, Cloneable {
	 ...
	 * @see NormOps#normF(org.ejml.data.D1Matrix64F)
	 */
	public double normF() {
	 ...
	 * @see DenseMatrix64F#getIndex(int, int)
	 */
...
// ret.logDeterminant = logDeterminant;
	 ...
	 * @see CommonOps#extractDiag(DenseMatrix64F, DenseMatrix64F)
	 */
